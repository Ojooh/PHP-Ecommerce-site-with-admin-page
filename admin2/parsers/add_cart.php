<?php
    ...
    if($cart_id != ''){
      ...
      if ($cart === NULL){
        ...
        $db->query("INSERT INTO cart (items,expired_date) VALUES ('{$items_json}','{$cart_expire}')");
      ...
      $cart_expire = date("Y-m-d H:i:s",strtotime("+30 days"));
      $db->query("UPDATE cart SET items = '{$items_json}', expired_date = '{$cart_expire}' WHERE id = '{$cart_id}'");
